...
class inputFile():
    ...
    def getGrid(self, gridInputFile, gridMatrix, grid):
        ...
        gridList = []
        while gridMatrix != '':  
            grid.append(gridMatrix)   
            gridList.append(gridMatrix.split(' '))
            gridMatrix = gridInputFile.readline().rstrip('\n').lower()
    ...
    def getInputs(self):
        ...
        maxRows, maxCols = inputFile.getNRowCol(self, gridMatrix)
       
        grid = []
        dictValidList = []
        
        #Get elements in the grid 
        self.grid, self.gridList = inputFile.getGrid(self, gridInputFile, gridMatrix, grid)
        ...
        return self.gridList, self.dictValidList, maxRows, maxCols